...
MQTT_C_EXAMPLES = bin/simple_publisher bin/simple_subscriber bin/reconnect_subscriber bin/bio_publisher bin/openssl_publisher bin/uev_subscriber
...
bin/uev_%: examples/uev_%.c $(MQTT_C_SOURCES)
	$(CC) $(CFLAGS) $^ -lpthread -luev -o $@
